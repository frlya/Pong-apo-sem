...
SOURCES = ball.c pads.c peripherals.c player_data.c menu.c game_controller.c main.c mzapo_phys.c mzapo_parlcd.c
...
SSH_OPTIONS=-o 'ProxyJump=login@postel.felk.cvut.cz'
